    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard / Insérer un produit 
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="product_cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option> Selectionner une catégorie de produit </option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="submit" value="Inserer le produit" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['submit'])){
    ...
    if($run_product){
        ...
        echo "<script>alert('Un nouveau produit a été insérée')</script>";
