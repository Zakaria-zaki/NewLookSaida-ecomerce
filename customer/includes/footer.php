            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
               ...
               <h4>Pages</h4>
                ...
                <ul><!-- ul Begin -->
                    ...
                    <li><a href="my_account.php">Compte</a></li>
                </ul><!-- ul Finish -->
                
                <hr>
                
                <h4>Commande par Tél :</h4>
                
                 <ul><!-- ul Begin -->
                    <li> Tél : <b>055555555</b> </li>
                </ul><!-- ul Finish -->
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2019 Zakaria abdeljallil All Rights Reserve</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="#">Z&H</p>
