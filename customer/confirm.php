           ...
           <div class="col-md-6 offer"><!-- col-md-6 offer Begin -->
               ...
               <a href="#" class="btn btn-success btn-sm">
                   ...
                   if(!isset($_SESSION['customer_email'])){
                       ...
                       echo "Bonjour: " . $_SESSION['customer_email'] . "";
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="../index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/newlookred1.png" alt="M-dev-Store Logo" class="hidden-xs">
                   <img src="images/New_Look_Logo.jpg" alt="M-dev-Store Logo Mobile" class="visible-xs">
    ...
    ?>
           ...
           <div class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="confirm.php?update_id=<?php  echo $order_idsh;  ?>" method="post" enctype="multipart/form-data" ><!-- form Begin -->
                       
                       <div class="form-group"><!-- form-group Begin -->
                           
                         <label> Invoice No: </label>
                          
                          <input type="text" value="<?php  echo $invoice_no;  ?>" class="form-control" name="invoice_no" required>
                       ...
                       <div class="form-group"><!-- form-group Begin -->
                         ...
                         <label> Amount Sent: </label>
                          ...
                          <input type="text" value="<?php  echo $due_amount;  ?>" class="form-control" name="amount_sent" required>
