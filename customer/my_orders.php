<center><!--  center Begin  -->
    ...
    <p class="text-muted">
        ...
        Si vous avez des questions, n'hésitez pas à <a href="../contact.php">Contactez nous
</a>. Notre service client fonctionne <strong>24/7</strong>
...
<div align="right"><h1>Totale : <?php echo $tot; ?> DA</h1></div>
