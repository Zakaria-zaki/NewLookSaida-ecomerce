   ...
   <div id="cart" class="col-md-9"><!-- col-md-9 Begin -->
               ...
               <div class="box"><!-- box Begin -->
                   ...
                   <form action="cart.php" method="post" enctype="multipart/form-data"><!-- form Begin -->
                       ...
                       <p class="text-muted">Vous avez actuellement <?php echo $count; ?> Articles dans votre panier</p>
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   ...
                   <div class='col-md-3 col-sm-6 center-responsive'><!-- col-md-3 col-sm-6 center-responsive Begin -->
                       <div class='card'><!-- product same-height Begin -->
           ...
           <div class="col-md-3"><!-- col-md-3 Begin -->
               ...
               <div id="order-summary" class="box"><!-- box Begin -->
                   ...
                   <p class="text-muted"><!-- text-muted Begin -->
                     ...
                     Les frais d'expédition et les frais supplémentaires sont calculés en fonction de la valeur entrée
                   ...
                   </div><!-- table-responsive Finish --></div><!-- box Finish -->
